...
//.i-1 и сравнить его с числом 4 (сравнение ==). Результат сравнения - true или false выведите в .out-1.
...
function f3() {
    const first_number = +document.querySelector(".i-31").value;
    const last_number = +document.querySelector(".i-32").value;
    if(first_number < last_number){
        document.querySelector(".out-3").textContent = last_number;
    }
    else{
        document.querySelector(".out-3").textContent = first_number;
    }
}
...
function f4() {
    ...
    const date_of_Bird = +document.querySelector(".i-4").value;
    const age = currentYear - date_of_Bird;
    if(age >= 18){
...
// Task 5.
// На странице есть input c классом i-5, куда пользователь может ввести число. Есть кнопка b-5 которая запускает функцию f5. 
...
// Функция должна число из .i-71 возвести в степень .i-72, вывести результат в  .out-7. Для возведения в степень можно использовать **, или Math.pow.

function f7() {
    const number1 = +document.querySelector(".i-71").value;
    const number2 = +document.querySelector(".i-72").value;
    document.querySelector(".out-7").textContent = number1**number2;
}
...
function f8() {
    switch(+document.querySelector(".s-8").value){
        case 1: document.querySelector(".out-8").textContent = 'one';
        break;
        case 2: document.querySelector(".out-8").textContent = 'two';
        break;
        case 3: document.querySelector(".out-8").textContent = 'three';
        break;
    }
}
...
function f9() {
    const number = document.querySelector(".i-9").value;
...
function f10() {
    const select_item = document.querySelector(".s-100").value
    document.querySelector(".out-10").textContent = select_item;
}
...
function f12() {
    document.querySelector(".out-12").textContent = typeof i120;
}
...
function f14() {
    ...
    switch (document.querySelector(".s-143").value){
        case "+": document.querySelector(".out-14").textContent = input1 + input2;
        break;
        case "-": document.querySelector(".out-14").textContent = input1 - input2;
        break;
        case "*": document.querySelector(".out-14").textContent = input1 * input2;
...
function f15() {
    const input1 = +document.querySelector(".s-151").value;
    const input2 = +document.querySelector(".s-152").value;
    const operation = document.querySelector(".s-153").value;
